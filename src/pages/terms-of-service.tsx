export default function TermsOfServicePage() {
    return (
        <main className="container mx-auto py-24">
            <p>
                <span>Last updated: 04/01/2020</span>
            </p>
            <p>
                <span>
                    <b>Introduction</b>
            ...
            <h1>Welcome to Bonus Action</h1>
            <p>
                <span>
                    Welcome to <b>Bonus Action</b> (“<b>Company</b>”, “<b>we</b>”, “<b>our</b>”, “<b>us</b>”)! As you
                    have just clicked to our Terms of Service, please make a pause, grab a cup of coffee and carefully
                    read the following pages. It will take you approximately 20 minutes.
                </span>
            </p>
            <p>
                <span>
                    These Terms of Service (“<b>Terms</b>”, “<b>Terms of Service</b>”) govern your use of our web pages
                    located at{' '}
                    <a href="https://thebonusaction.com" target="_blank" rel="noopener noreferrer">
                        https://thebonusaction.com
                    </a>
                    operated by Bonus Action
                </span>
            </p>
            <p>
                <span>
                    ...
                    <a href="https://thebonusaction.com/privacy-policy/" target="_blank" rel="noopener noreferrer">
                        https://thebonusaction.com/privacy-policy/
                    </a>
                    .
                </span>
            </p>
            <p>
                <span>
                    Your agreement with us includes these Terms and our Privacy Policy (“<b>Agreements</b>”). You
            ...
            <p>
                <span>
                    ...
                    please let us know by emailing at info@thebonusaction.com so we can try to find a solution. These
            ...
            <p>
                <span>
                    If you wish to purchase any product or service made available through Service (“<b>Purchase</b>”),
            ...
            <p>
                <span>
                    Any contests, sweepstakes or other promotions (collectively, “<b>Promotions</b>”) made available
            ...
            <p>
                <span>
                    Bonus Action, in its sole discretion and at any time, may modify Subscription fees for the
            ...
            <p>
                <span>
                    Bonus Action will provide you with a reasonable prior notice of any change in Subscription fees to
            ...
            <p>
                <span>
                    {' '}
                    Content found on or through this Service are the property of Bonus Action or used with permission.
            ...
            <ol>
                <li>
                    <ol>
                        ...
                        <li>
                            <span>Take any action that may damage or falsify Company rating.</span>
                        </li>
                        <li>
                            <span>Otherwise attempt to interfere with the proper working of Service.</span>
                        </li>
                    </ol>
                </li>
            </ol>
            ...
            <p>
                <span>
                    ...
                    are and will remain the exclusive property of Bonus Action and its licensors. Service is protected
                    by copyright, trademark, and other laws of the United States and foreign countries. Our trademarks
                    and trade dress may not be used in connection with any product or service without the prior written
                    consent of Bonus Action.
                </span>
            </p>
            <h2>
                <span>
            ...
            <p>
                <span>
                    ...
                    email to info@thebonusaction.com, with the subject line: “Copyright Infringement” and include in
            ...
            <p>
                <span>
                    ...
                    <a href="mailto:info@thebonusaction.com">info@thebonusaction.com</a>
                </span>
            </p>
            <h2></h2>
            <h2>
            ...
            <p>
                <span>
                    You may provide us directly at <a href="mailto:info@thebonusaction.com">info@thebonusaction.com</a>{' '}
                    with information and feedback concerning errors, suggestions for improvements, ideas, problems,
                    complaints, and other matters related to our Service (“<b>Feedback</b>”). You acknowledge and agree
                    that: (i) you shall not retain, acquire or assert any intellectual property right or other right,
                    title or interest in or to the Feedback; (ii) Company may have development ideas similar to the
                    Feedback; (iii) Feedback does not contain confidential information or proprietary information from
                    you or any third party; and (iv) Company is not under any obligation of confidentiality with respect
                    to the Feedback. In the event the transfer of the ownership to the Feedback is not possible due to
            ...
            <p>
                <span>
                    Bonus Action has no control over, and assumes no responsibility for the content, privacy policies,
            ...
            <p>
                You acknowledge and agree that bonus action shall not be responsible or liable, directly or indirectly,
            ...
            <p>
                <span>If you wish to terminate your account, you may simply discontinue using Service.</span>
            </p>
            <p>
                <span>
            ...
            <p>
                <span>Please send your feedback, comments, requests for technical support:</span>
            </p>
            <p>
                <span>
                    By email: <a href="mailto:info@thebonusaction.com">info@thebonusaction.com</a>.
                </span>
            </p>
        </main>
    );
