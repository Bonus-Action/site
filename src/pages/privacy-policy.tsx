export default function PrivacyPolicyPage() {
    return (
        <main className="container mx-auto py-24">
            ...
            <p>
                Bonus Action&nbsp;(“us”, “we”, or “our”) operates&nbsp;
            ...
            <p>
                ...
                website&nbsp;operated by&nbsp;Bonus Action
            </p>
            <p>
            ...
            <p>&nbsp;</p>
            <h2>Use of Data</h2>
            <p>Bonus Action&nbsp;uses the collected data for various purposes:</p>
            <ul>
                ...
                <li>to fullfill any other purpose for which you provide it;</li>
                <li>
            ...
            <p>
                Bonus Action&nbsp;will take all the steps reasonably necessary to ensure that your data is treated
            ...
            <p>
                ...
                our systems, please email us at info@thebonusaction.com.
            </p>
            ...
            <p>
                CalOPPA is the first state law in the United States to require commercial websites and online services
            ...
            <ul>
                ...
                <li>users are able to change their personal information by emailing us at info@thebonusaction.com.</li>
            </ul>
            <p>
                <strong>
            ...
            <p>What personal information we have about you. If you make this request, we will return to you:</p>
            <ul>
                ...
                <li>
                    A list of categories of personal information that we have disclosed for a business purpose, along
            ...
            <p>
                To delete your personal information. If you make this request, we will delete the personal information
                we hold about you as of the date of your request from our records and direct any service providers to do
                the same. In some cases, deletion may be accomplished through de-identification of the information. If
                you choose to delete your personal information, you may not be able to use certain functions that
            ...
            <p>
                ...
                parties for any purpose. You are the only owner of your Personal Data and can request disclosure or
