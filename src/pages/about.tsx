        ...
        <main className="container mx-auto py-24 flex">
            <section className="flex-1 pr-20">
                ...
                <p>
                    ...
                    internet not long after. People seemed to enjoy my work and I&apos;ve been creating and sharing
                    fresh homebrew content on a regular basis ever since.
                </p>
                <p>
                    I&apos;ve always been super passionate about creating artwork and have been improving my skills in
                    digital art over the past few years. Thanks to Dungeons and Dragons I&apos;ve discovered how much I
                    enjoy using my artistic skills in combination with creative writing and worldbuilding. It&apos;s my
                    goal to create unique, accessible and useful content for people to incorporate in their own games.
                </p>
                <p>
